				...
				<div id="content">
					...
					<div class="post">
						...
						<p class="meta"><?php echo $newsItem['date'];?>
                            &nbsp;&bull;&nbsp;<a href='/news/<?php echo $newsItem['id'] ;?>' class="permalink"></a></p>
						<div class="entry">
							<p><img src="/template/images/pic02.jpg" width="800" height="300" alt="" /></p>
							<p><?php echo $newsItem['short_content'];?></p>
						</div>
                        <div class="meta">
                            <p><a href="/news/<?php echo $newsItem['id'] ?>">Читать далее ...</a></p>
                        </div>
					</div>
				<?php endforeach;?>
